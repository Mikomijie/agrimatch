      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10 py-8 sm:py-12">
        ...
        <div className="grid md:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 items-start">
          <div>
            ...
            <h1 className="font-[var(--font-heading)] text-4xl sm:text-5xl md:text-6xl text-[var(--color-charcoal)] mb-4 sm:mb-6">
              {product.crop_type}
            </h1>
            ...
            <div className="grid grid-cols-2 gap-6 mt-8 sm:mt-10">
              <div>
                <p className="text-xs font-bold tracking-wider text-[var(--color-charcoal)]/60 uppercase mb-2">Available Quantity</p>
                <p className="text-2xl sm:text-3xl font-bold text-[var(--color-charcoal)]">{product.quantity} kg</p>
              </div>
              <div>
                <p className="text-xs font-bold tracking-wider text-[var(--color-charcoal)]/60 uppercase mb-2">Location</p>
                <p className="text-2xl sm:text-3xl font-bold text-[var(--color-charcoal)]">{product.location}</p>
              </div>
              <div>
                <p className="text-xs font-bold tracking-wider text-[var(--color-charcoal)]/60 uppercase mb-2">Price per kg</p>
                <p className="font-[var(--font-heading)] text-2xl sm:text-3xl font-bold text-[var(--color-secondary)]">GH₵{product.price_per_unit}</p>
              </div>
              <div>
                <p className="text-xs font-bold tracking-wider text-[var(--color-charcoal)]/60 uppercase mb-2">Farmer Rating</p>
